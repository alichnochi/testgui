...
--     colors = {
--     main = Color3.fromHex("FF8C00"),          -- ส้มหลัก (Dark Orange)
--     background = Color3.fromRGB(0, 0, 0),     -- ดำ
--     outerBorder = Color3.fromRGB(0, 0, 0),
--     innerBorder = Color3.fromHex("8A3F00"),   -- น้ำตาลส้มเข้ม
--     topGradient = Color3.fromRGB(0, 0, 0),
--     bottomGradient = Color3.fromHex("2B1400"),-- ดำอมส้ม
--     sectionBackground = Color3.fromHex("1A0D00"),
--     section = Color3.fromHex("FF8C00"),       -- ส้มสด
--     otherElementText = Color3.fromHex("FF8C00"),
--     elementText = Color3.fromHex("E0E0E0"),   -- เทาอ่อน อ่านง่าย
--     elementBorder = Color3.fromHex("5A2A00"), -- ขอบน้ำตาลเข้ม
--     selectedOption = Color3.fromHex("331800"), 
--     unselectedOption = Color3.fromHex("331800"),
--     hoveredOptionTop = Color3.fromHex("4A2300"),
--     unhoveredOptionTop = Color3.fromHex("331800"),
--     hoveredOptionBottom = Color3.fromHex("4A2300"),
--     unhoveredOptionBottom = Color3.fromHex("331800"),
--     tabText = Color3.fromHex("E0E0E0")
-- },
    colors = {
        main = Color3.fromHex("FF7A00"),          -- ส้มหลัก (Gaming Orange)
        background = Color3.fromRGB(0, 0, 0),     -- ดำสนิท
        outerBorder = Color3.fromRGB(0, 0, 0),
        innerBorder = Color3.fromHex("5C2A00"),   -- ส้มไหม้เข้ม
        topGradient = Color3.fromRGB(0, 0, 0),
        bottomGradient = Color3.fromHex("140900"),-- ดำอมส้มเข้มมาก
        sectionBackground = Color3.fromHex("0F0700"),
        section = Color3.fromHex("FF7A00"),
        otherElementText = Color3.fromHex("FF7A00"),
        elementText = Color3.fromHex("D0D0D0"),   -- เทาอ่อน อ่านชัด
        elementBorder = Color3.fromHex("3A1A00"),
        selectedOption = Color3.fromHex("241000"),
        unselectedOption = Color3.fromHex("241000"),
        hoveredOptionTop = Color3.fromHex("3A1A00"),
        unhoveredOptionTop = Color3.fromHex("241000"),
        hoveredOptionBottom = Color3.fromHex("3A1A00"),
        unhoveredOptionBottom = Color3.fromHex("241000"),
        tabText = Color3.fromHex("D0D0D0")
    },
